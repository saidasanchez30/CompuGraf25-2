...
int main()
{
	...
	CrearDado();
	CreateShaders();
	CrearOctaedro();//índice 1 en MeshList
	...
	dadoTextureAnimal = Texture("Textures/dado_animal.png");
	dadoTextureAnimal.LoadTextureA();
